...
class WaveletDWTLayer(nn.Module):
    """Convolution layer for running DWT and IDWT on signal or approximation coefficient."""
    ...
    def run_dwt(self, signal: torch.Tensor) -> tuple[torch.Tensor, torch.Tensor]:
    ...
    def run_wavelet_computation(self,
        ...
        pywt.orthogonal_filter_bank(rec_lo)
