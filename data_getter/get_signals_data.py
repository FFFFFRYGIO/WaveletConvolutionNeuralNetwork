...
def get_signals_data(
        signal_time: int | None, amounts: dict[str, int] = None, normalization: str | None = 'max-abs'
    ...
    signals_data = get_from_github(amounts['NSR'], 'NSR', signal_time, normalization=normalization)
    return signals_data
